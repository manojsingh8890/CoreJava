...
public class ApplicationService {
     ...
     * @return
     */
    public Mono<String> getDevicesWithalgoSecUniqueName(UserSession session, String algosecUniqueNames) {
        return restUtil.makeGetCallToMSSAPIs(session, servicesConfig.getDeviceUrlWithAlgosecUniqueName(), String.class, algosecUniqueNames);
    }
