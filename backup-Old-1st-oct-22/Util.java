...
public class Util {
    ...
    private final String REGEX_RISK_REPORT_PATTERN = "\"Risk\" : \\[[^*]+\\]";
    private final Pattern RISK_REPORT_PATTERN = Pattern.compile(REGEX_RISK_REPORT_PATTERN);
    ...
    public String riskReportRegexMatch(String inputString) {
        return findMatch(inputString, RISK_REPORT_PATTERN);
    }
